...
class UnityAdsPlugin(godot: Godot) : GodotPlugin(godot),
    ...
    fun initialize(gameId: String, testMode: Boolean) {
        runOnUiThread { UnityAds.initialize(activity!!, gameId, testMode, this) }
    }

    @UsedByGodot
    fun load_ad(placementId: String) { UnityAds.load(placementId, this) }

    @UsedByGodot
    fun show_ad(placementId: String) {
        runOnUiThread { UnityAds.show(activity!!, placementId, UnityAdsShowOptions(), this) }
    }
    ...
    override fun onUnityAdsAdLoaded(placementId: String) { emitSignal("ad_loaded", placementId) }
    ...
    override fun onUnityAdsShowStart(placementId: String) { emitSignal("ad_showed", placementId) }
    override fun onUnityAdsShowClick(placementId: String) { emitSignal("ad_clicked", placementId) }
}
